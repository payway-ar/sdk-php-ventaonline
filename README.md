...
|amount  |importe del pago   |  SI| Se ingresa asi: Importe Maximo = 9223372036854775807 y se visualiza asi: ($92233720368547758.07) |amount=20000  |
...
|payment.amount  | Monto de la compra  | SI | Numérico | 1000  |
...
$data = array(
  ...
  "payment" => array(
        "amount" => 1203,    //aqui toma el 03 como la parte decimal sin ingresar caracter(.)
        "currency" => "ARS",
        "payment_method_id" => 1,
        "bin" => "45979",
        "installments" => 4,
...
|Campo | Descripcion  | Oblig | Restricciones  |Ejemplo|
| ------------ | ------------ | ------------ | ------------ | ------------ |
| amount  | importe del pago a devolver  |NO   | Antes del cierre, si se completa el campo por un monto menor al de la compra se toma como devolucion parcial; si se ingresa el monto total o no se envia dicho campo se toma como anulacion. |  1000 ( no se ingresa caracter separador de decimal) |
